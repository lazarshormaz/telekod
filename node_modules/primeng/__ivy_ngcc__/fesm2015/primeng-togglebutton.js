...
const _c0 = ["checkbox"];
const _c1 = function (a0, a1) { return { "ui-button-icon-left": a0, "ui-button-icon-right": a1 }; };
...
const _c2 = function (a1, a2, a3, a4, a5, a6, a7) { return { "ui-button ui-togglebutton ui-widget ui-state-default ui-corner-all": true, "ui-button-text-only": a1, "ui-button-text-icon-left": a2, "ui-button-text-icon-right": a3, "ui-button-icon-only": a4, "ui-state-active": a5, "ui-state-focus": a6, "ui-state-disabled": a7 }; };
